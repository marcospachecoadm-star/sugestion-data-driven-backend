...
import '/components/card_negativo_oficial_widget.dart';
...
import 'd_estoque_negativo_oficial_model.dart';
export 'd_estoque_negativo_oficial_model.dart';
...
class DEstoqueNegativoOficialWidget extends StatefulWidget {
  const DEstoqueNegativoOficialWidget({super.key});

  static String routeName = 'D_EstoqueNegativo_Oficial';
  static String routePath = '/dEstoqueNegativoOficial';

  @override
  State<DEstoqueNegativoOficialWidget> createState() =>
      _DEstoqueNegativoOficialWidgetState();
}

class _DEstoqueNegativoOficialWidgetState
    extends State<DEstoqueNegativoOficialWidget> {
  late DEstoqueNegativoOficialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DEstoqueNegativoOficialModel());
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: wrapWithModel(
                              ...
                              updateCallback: () => safeSetState(() {}),
                              child: IndicatorSummaryCard2Widget(
                                label: 'Possivel Perda Projetada',
                                valor: valueOrDefault<String>(
                                  rowIndicadoresResumoRecord
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: BuscarIndicadoresItensCall.call(
                        indicadorTipo: 'estoque_negativo',
                        q: _model.buscarGiro,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                          ...
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, itemIndicadorIndex) {
                                ...
                                return CardNegativoOficialWidget(
                                  key: Key(
                                      'Keyly2_${itemIndicadorIndex}_of_${itemIndicador.length}'),
