...
import 'f_itens_em_ruptura_oficial_model.dart';
export 'f_itens_em_ruptura_oficial_model.dart';
...
class FItensEmRupturaOficialWidget extends StatefulWidget {
  const FItensEmRupturaOficialWidget({super.key});

  static String routeName = 'F_ItensEmRuptura_Oficial';
  static String routePath = '/fItensEmRupturaOficial';

  @override
  State<FItensEmRupturaOficialWidget> createState() =>
      _FItensEmRupturaOficialWidgetState();
}

class _FItensEmRupturaOficialWidgetState
    extends State<FItensEmRupturaOficialWidget> {
  late FItensEmRupturaOficialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FItensEmRupturaOficialModel());
            ...
            StreamBuilder<List<IndicadoresResumoRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<IndicadoresResumoRecord>
                    containerIndicadoresResumoRecordList = snapshot.data!;
                // Return an empty Container when the item does not exist.
                if (snapshot.data!.isEmpty) {
                  return Container();
                }
                final containerIndicadoresResumoRecord =
                    containerIndicadoresResumoRecordList.isNotEmpty
                        ? containerIndicadoresResumoRecordList.first
                        : null;
                    ...
                    child: Container(
                      child: StreamBuilder<List<IndicadoresResumoRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<IndicadoresResumoRecord>
                              rowIndicadoresResumoRecordList = snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final rowIndicadoresResumoRecord =
                              rowIndicadoresResumoRecordList.isNotEmpty
                                  ? rowIndicadoresResumoRecordList.first
                                  : null;
                          ...
                          return Row(
                            ...
                            children: [
                              Expanded(
                                flex: 1,
                                child: wrapWithModel(
                                  model: _model.indicatorSummaryCardModel1,
                                  updateCallback: () => safeSetState(() {}),
                                  child: IndicatorSummaryCard2Widget(
                                    label: 'Itens em Ruptura',
                                    valor: valueOrDefault<String>(
                                      rowIndicadoresResumoRecord?.itensRuptura
                                          ?.toString(),
                                      '2.0',
                                    ),
                                    corValor: '',
                              ...
                              Expanded(
                                flex: 1,
                                child: wrapWithModel(
                                  model: _model.indicatorSummaryCardModel2,
                                  updateCallback: () => safeSetState(() {}),
                                  child: IndicatorSummaryCard2Widget(
                                    label: 'Perda de Vendas',
                                    valor: valueOrDefault<String>(
                                      rowIndicadoresResumoRecord
                                          ?.valorPerdaRupturaFormatado,
                                      '2.0',
                                    ),
                                    corValor: '',
                                  ),
                          ...
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, itemIndicadorIndex) {
                                ...
                                return CardEmRupturaOficialWidget(
                                  key: Key(
                                      'Keyfgm_${itemIndicadorIndex}_of_${itemIndicador.length}'),
                                  ...
                                  diassemvenda: itemIndicadorItem.toString(),
                                  valorparado: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.valor_perda_ruptura_formatado''',
                                  ).toString(),
                                );
                              },
                            );
