...
import 'g_itens_sem_vendas_oficial_model.dart';
export 'g_itens_sem_vendas_oficial_model.dart';
...
class GItensSemVendasOficialWidget extends StatefulWidget {
  const GItensSemVendasOficialWidget({super.key});

  static String routeName = 'G_ItensSemVendas_Oficial';
  static String routePath = '/gItensSemVendasOficial';

  @override
  State<GItensSemVendasOficialWidget> createState() =>
      _GItensSemVendasOficialWidgetState();
}

class _GItensSemVendasOficialWidgetState
    extends State<GItensSemVendasOficialWidget> {
  late GItensSemVendasOficialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GItensSemVendasOficialModel());
                          ...
                          Expanded(
                            ...
                            child: wrapWithModel(
                              ...
                              child: IndicatorSummaryCard2Widget(
                                label: 'Itens Sem Vendas',
                                valor: valueOrDefault<String>(
                                  rowIndicadoresResumoRecord?.itensSemVendas
                                      ?.toString(),
                                  '2.0',
                                ),
                                corValor: '',
                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: BuscarIndicadoresItensCall.call(
                        indicadorTipo: 'itens_sem_vendas',
                        q: _model.buscarGiro,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                          ...
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, itemIndicadorIndex) {
                                ...
                                return CardSemVendasOficialWidget(
                                  key: Key(
                                      'Keya0c_${itemIndicadorIndex}_of_${itemIndicador.length}'),
                                  ...
                                  diassemvenda: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.dias_sem_venda''',
                                  ).toString(),
                                  ultimavenda: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.ultima_venda_em_formatada''',
                                  ).toString(),
                                  valorparado: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.valor_parado_formatado''',
                                  ).toString(),
                                );
                              },
                            );
