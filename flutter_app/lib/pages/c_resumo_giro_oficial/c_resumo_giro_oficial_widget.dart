...
import '/components/card_giro_oficial_widget.dart';
...
import 'c_resumo_giro_oficial_model.dart';
export 'c_resumo_giro_oficial_model.dart';
...
class CResumoGiroOficialWidget extends StatefulWidget {
  const CResumoGiroOficialWidget({super.key});

  static String routeName = 'C_ResumoGiro_Oficial';
  static String routePath = '/cResumoGiroOficial';

  @override
  State<CResumoGiroOficialWidget> createState() =>
      _CResumoGiroOficialWidgetState();
}

class _CResumoGiroOficialWidgetState extends State<CResumoGiroOficialWidget> {
  late CResumoGiroOficialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CResumoGiroOficialModel());
                            ...
                            child: wrapWithModel(
                              ...
                              child: IndicatorSummaryCard2Widget(
                                ...
                                valor: valueOrDefault<String>(
                                  rowIndicadoresResumoRecord?.giroMedio45d
                                      ?.toString(),
                                  '2.0',
                                ),
                                corValor: '',
                          ...
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, itemIndicadorIndex) {
                                ...
                                return CardGiroOficialWidget(
                                  key: Key(
                                      'Keycmk_${itemIndicadorIndex}_of_${itemIndicador.length}'),
                                  produto: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.produto_nome''',
                                  ).toString(),
                                  statusBackgroundColor: Color(0x00000000),
                                  ...
                                  vendas45d: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.vendas_45d''',
                                  ).toString(),
                                  giroMedio: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.giro_45d_formatado''',
                                  ).toString(),
                                  estoque: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.estoque_atual''',
                                  ).toString(),
                                  cobertura: getJsonField(
                                    itemIndicadorItem,
                                    r'''$.cobertura_dias''',
                                  ).toString(),
                                );
