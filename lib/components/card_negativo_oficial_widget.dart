...
import 'card_negativo_oficial_model.dart';
export 'card_negativo_oficial_model.dart';

class CardNegativoOficialWidget extends StatefulWidget {
  const CardNegativoOficialWidget({
    super.key,
    String? produto,
  ...
  @override
  State<CardNegativoOficialWidget> createState() =>
      _CardNegativoOficialWidgetState();
}

class _CardNegativoOficialWidgetState extends State<CardNegativoOficialWidget> {
  late CardNegativoOficialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardNegativoOficialModel());
